...
#ifndef GUI_DIALOG_ADDONMANAGER_H
#define GUI_DIALOG_ADDONMANAGER_H
 ...
 * @author Werner Mayer
 */
class Ui_AddonManager;
class GuiExport AddonManager : public QDialog
{
    Q_OBJECT

public:
    AddonManager(QWidget* parent = 0, Qt::WindowFlags fl = 0);
    ~AddonManager();
...
#endif // GUI_DIALOG_ADDONMANAGER_H
